    ...
    return (
        <div>
            <div className="container">
                <div className="mb-3">
                    <label htmlFor="myBox" className="form-label">  <h1 style={{ color: props.mode==='dark'?'white':'black' }}>{props.heading}</h1></label>

                    <textarea className="form-control" style={{ backgroundColor: props.mode === 'dark' ? 'gray' : 'white' }} id="myBox" rows="8" value={text} onChange={handalOnChange} ></textarea>
                </div>
                ...
                <div className="btn btn-outline-primary btn-block mx-3" onClick={handalRemoveSpace}>Remove Extra Spaces</div>

            </div>
            <div className="container my-3">

                <h2 style={stylesum}>Your text summay</h2>
